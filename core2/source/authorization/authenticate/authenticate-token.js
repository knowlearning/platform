import { uuid, environment, decryptBase64String } from '../externals.js'
  ...
  return new Promise( async (resolve, reject) => {
    if (authority === 'core') JWTVerification('core', token, resolve, reject)
      ...
      try {
        ...
        else if (OAuthClientInfo[provider.toUpperCase()]) JWTVerification(provider, code, resolve, reject)
