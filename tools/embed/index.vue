  ...
  >
    <Pane>
      <div v-if="environment" class="wrapper">
        ...
        <button @click="addUrl('https://bettysbrain.knowlearning.systems/bb/climate-change/causal-map')">Betty's Brain</button>
        <button @click="addUrl(`https://bettysbrain-dashboard.knowlearning.systems/bb-dash/climate-change/OverviewView?dashboard-config=${bbDashboardConfigId}`)">Betty's Brain Dashboard</button>
